...
if ( $_SERVER["REQUEST_METHOD"] == "POST" ) {
	...
	if ( isset( $_POST['userID'] ) && isset( $_POST['cudOption'] ) ) {
		...
		echo $verifications->json_response( 200, $_POST['userID']);
		return;
	}
	...
	if ( isset( $_POST['genre'] ) ) {
		...
		echo $verifications->json_response( 200, $verifications::updateUsersInformation( $_POST['city'],
			...
			$_POST['phone'],
			$_POST['street'] ) );
		if ( isset( $_POST['country_nac'] ) ) {
			$update->setMetaData( 'country_nac', $_POST['country_nac'] );
		}
		if ( isset( $_POST['livingZone'] ) ) {
			$update->setMetaData( 'livingZone', $_POST['livingZone'] );
		}
	...
	if ( isset( $_POST['userID'] ) && isset( $_POST['preferJobs'] ) ) {
		...
		if ( isset( $_POST['workingSearch'] ) ) {
			$update->setMetaData( 'workingSearch', $_POST['workingSearch'] );
		}
