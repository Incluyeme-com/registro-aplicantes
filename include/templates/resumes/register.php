...
wp_enqueue_script( 'vueH', $js . 'vue4.0.2.js', [ 'vueJS', 'FAwesome' ], date( "h:i:s" ), true );
							...
							<div class="row">
								<div class="col">
									<h4 id="OptionCVLabel">
										...
										*?</h4>
											<small v-if="validation === 29" class="form-text text-error">Por favor, dinos si cuentas con certificado.</small>
									<x-incluyeme class="row">
										<x-incluyeme class="col-12">
											<x-incluyeme class="d-flex flex-fill">
												<x-incluyeme class="form-check form-check-inline">
